...
router = APIRouter(
    ...
    responses={404: {"description": "Analysis and Statistics about Shops, Robots etc."}}
)

### ANALYSIS ENDPOINTS ###

#@router.get("/analysis/shops/general", response_model=AnalysisResponse)
@router.get("/analysis/shops/general", name="PUDU-Annotation: Store analytics")
...
#@router.get("/analysis/shops/cleaning/detail", response_model=AnalysisResponse)
@router.get("/analysis/shops/cleaning/detail", name="PUDU-Annotation: Machine Task Analysis [Cleaning Line] - Cleaning Mode Working Session Distribution")
...
#@router.get("/analysis/shops/cleaning", response_model=AnalysisResponse)
@router.get("/analysis/shops/cleaning", name="PUDU-Annotation: Machine Task Analysis [Cleaning Line] - Cleaning Mode")
...
#@router.get("/analysis/shops/industrial", response_model=AnalysisResponse)
@router.get("/analysis/shops/industrial", name="PUDU-Annotation: Machine Task Analysis[Industrial Line] - Jacking Mode")
...
#@router.get("/analysis/shops/delivery", response_model=AnalysisResponse)
@router.get("/analysis/shops/delivery", name="PUDU-Annotation: Machine task analysis [distribution line] - distribution mode")
...
#@router.get("/analysis/shops/cruise", response_model=AnalysisResponse)
@router.get("/analysis/shops/cruise", name="PUDU-Annotation: Machine Mission Analysis [Distribution Line] - Cruise Mode")
...
#@router.get("/analysis/shops/lead", response_model=AnalysisResponse)
@router.get("/analysis/shops/lead", name="PUDU-Annotation: Machine Mission Analysis [Distribution Line] - Lead Mode")
...
# @router.get("/analysis/robot/general", response_model=AnalysisResponse)
@router.get("/analysis/robot/general", name="PUDU-Annotation: Machine run analysis")
