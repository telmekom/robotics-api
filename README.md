...
* **Robot, Machine**: Interchangable terms to represents a robot - identified by a Serial Number (sn). This robot is bount to one store.
...
* **Robot Type**: Could be Industrial (f.ex. T600, T300), Cleaning (MT1, CC1, SH1) and Delivery (FlashBot, BellaBot, KettyBot, PuduBot, HolaBot). X-Lab / X-Series is not yet available. A list of Robots and details can be found on the PUDU-Website
